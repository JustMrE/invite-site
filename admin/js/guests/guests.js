...
// // ✅ Показываем модалку для выбора типа связи
...
//     const existing = Object.entries(allGuests).find(([id, g]) => g.name === relatedName);
//     let relatedId;
...
//     uploadedAt: new Date().toISOString()
//   }).then(() => {
//     const updatePromises = relatedUpdates.map(({ relatedId, reverseType }) => {
...
//       bootstrap.Modal.getInstance(document.getElementById("editGuestModal") || document.getElementById("addGuestModal")).hide();
//       loadGuestsFromFirebase();
//     });
